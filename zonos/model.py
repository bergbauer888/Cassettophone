...
class Zonos(nn.Module):
    ...
    def generate(
        ...
        # MPS doesn't support torch.compile
        disable_torch_compile = cg or disable_torch_compile or device.type == "mps"
        decode_one_token = torch.compile(self._decode_one_token, dynamic=True, disable=disable_torch_compile)
